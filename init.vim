...
let g:coc_global_extensions = ['coc-webview', 'coc-pyright', 'coc-translator', 'coc-snippets', 'coc-prettier', 'coc-highlight', 'coc-git', 'coc-actions', 'coc-vimlsp', 'coc-julia', 'coc-json', 'coc-markmap', 'coc-sumneko-lua', 'coc-stylua', 'coc-clangd', 'coc-rust-analyzer', 'coc-vetur']
